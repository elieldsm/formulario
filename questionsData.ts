...
export const questionsData = {
  "Pacote Start – Presença Digital": {
    ...
    "5 Imagens profissionais IA (realistas ou artísticas)": [
      { id: "start_image_goal", type: "textarea", label: "Qual é o objetivo de cada imagem? (Ex: post para redes sociais, banner para site, ilustração)" },
  ...
  "Pacote Growth – Expansão": {
    "6 Vídeos (até 45s cada)": [
        ...
        { id: "growth_video_style", type: "radio", label: "Preferência de estilo visual ou tom?", options: ["Formal", "Divertido", "Informativo", "Outro"] },
        { id: "growth_video_reference", type: "textarea", label: "Você tem algum material de referência (imagens, vídeos, áudios)?" },
    ...
    "12 Imagens IA (realistas, 3D ou artísticas)": [
        ...
        { id: "growth_image_reference", type: "textarea", label: "Imagem de referência ou elementos a incluir/excluir?" },
        { id: "growth_image_3d_context", type: "textarea", label: "Preferência por imagens 3D em algum contexto específico?" },
    ],
  ...
  "Pacote Premium – Dominação Digital": {
    "12 Vídeos (até 60s cada)": [
      ...
      { id: "premium_video_style", type: "radio", label: "Preferência de estilo visual ou tom?", options: ["Formal", "Divertido", "Informativo", "Outro"] },
      { id: "premium_video_reference", type: "textarea", label: "Você tem algum material de referência (imagens, vídeos, áudios)?" },
    ...
    "20 Imagens IA (realistas, criativas, estilo 3D ou artísticas)": [
      ...
      { id: "premium_image_preference", type: "radio", label: "Preferência de estilo?", options: ["Realistas", "Criativas", "Estilo 3D", "Artísticas", "Mistura"] },
      { id: "premium_image_palette", type: "textarea", label: "Paleta de cores ou estilo visual específico?" },
      { id: "premium_image_reference", type: "textarea", label: "Imagem de referência ou elementos a incluir/excluir?" },
    ...
    "Clone facial & deepfake profissional (até 3 vídeos)": [
      ...
      { id: "premium_clone_requirements", type: "textarea", label: "Requisitos específicos para a qualidade e realismo do deepfake?" },
    ...
    "Criação de prompts inteligentes sob medida": [
      ...
      { id: "premium_prompt_goals", type: "textarea", label: "Quais são os objetivos desses prompts? (Ex: gerar ideias, otimizar conteúdo)" },
    ...
    "Consultoria estratégica 1x por mês": [
      { id: "premium_consulting_challenges", type: "textarea", label: "Principais desafios ou objetivos para discutir na consultoria?" },
  ...
  "Serviços Avulsos": {
    "Vídeo curto IA (até 30s)": [
      ...
      { id: "avulso_video_script", type: "textarea", label: "Existe algum roteiro ou pontos-chave?" },
      { id: "avulso_video_audience", type: "textarea", label: "Qual é o público-alvo?" },
      { id: "avulso_video_style", type: "radio", label: "Preferência de estilo ou tom?", options: ["Formal", "Divertido", "Informativo", "Outro"] },
      { id: "avulso_video_reference", type: "textarea", label: "Material de referência a incluir?" },
    ],
    "Imagem realista ou artística IA": [
      ...
      { id: "avulso_image_preference", type: "radio", label: "Prefere imagens realistas, artísticas, ou uma mistura?", options: ["Realistas", "Artísticas", "Mistura"] },
      { id: "avulso_image_palette", type: "textarea", label: "Paleta de cores ou estilo visual específico?" },
      { id: "avulso_image_reference", type: "textarea", label: "Imagem de referência ou elementos a incluir/excluir?" },
    ],
    "Música exclusiva IA": [
    ...
    "Clone facial simples": [
        ...
        { id: "avulso_clone_instruction", type: "textarea", label: "Instrução específica sobre a expressão ou movimento?" },
    ],
    "Deepfake profissional": [
        ...
        { id: "avulso_deepfake_simulation", type: "textarea", label: "Necessidade de simular falas ou expressões específicas?" },
    ],
